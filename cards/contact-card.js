export function renderContactCard(options = {}) {
  ...
  <rect x="20" y="16" width="124" height="28" rx="10" fill="#0a1323" fill-opacity="0.92" stroke="#314257"/>
  <rect x="20" y="16" width="124" height="28" rx="10" fill="url(#contact-accent)" opacity="0.08"/>
  <rect x="20" y="16" width="42" height="28" rx="10" fill="${withOpacity(accent, 0.14)}"/>
  <g transform="translate(32 24)">${icon}</g>
  <text x="70" y="35" fill="#dbeafe" font-size="11" font-weight="800" letter-spacing="1.2" font-family="'Segoe UI',Ubuntu,sans-serif">${label}</text>
