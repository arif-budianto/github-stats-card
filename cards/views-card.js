export function renderViewsCard(data = {}) {
  ...
  const username = escapeXml(cleanText(data.username || ""));
  ...
  <rect x="20" y="16" width="146" height="28" rx="10" fill="#0a1323" fill-opacity="0.92" stroke="#314257"/>
  <rect x="20" y="16" width="146" height="28" rx="10" fill="url(#views-accent)" opacity="0.08"/>
  ...
  <g transform="translate(306 24)">
    <rect width="60" height="44" rx="14" fill="#0a1323" fill-opacity="0.88" stroke="#314257"/>
    <text x="30" y="20" fill="#93a4b8" font-size="10" font-weight="800" letter-spacing="0.8" font-family="'Segoe UI',Ubuntu,sans-serif" text-anchor="middle">TRACKED</text>
    <text x="30" y="34" fill="#e2e8f0" font-size="11" font-weight="700" font-family="'Segoe UI',Ubuntu,sans-serif" text-anchor="middle">${username || "profile"}</text>
  </g>
</svg>`;
}
