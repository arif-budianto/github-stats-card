export function renderViewsCard(data = {}) {
  ...
  const usernameRaw = cleanText(data.username || "");
  const username = escapeXml(truncateText(usernameRaw || "profile", 11));
  const badgeWidth = 164;
  const trackedWidth = 82;
  ...
  <svg x="31" y="22" width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true">
